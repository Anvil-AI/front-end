    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="pb-6 flex justify-between">
        ...
        <div className="relative">
          ...
          <label className="absolute left-0 top-1 text-gray-600 cursor-text peer-focus:text-xs peer-focus:-top-4 peer-focus:text-purple-600 transition-all">Username</label>
        </div>  
